  ...
  def createDefaultSettings(){
    def settings = [
        ...
        [
            ...
            value: 'yes',
            settingsType: 'radio',
            description: 'If this is set to true, then after successful file-conversion the original file will be removed from the Upload Directory. This may be useful in case you have limited disk space.'
        ],
    ]
